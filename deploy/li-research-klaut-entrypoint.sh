...
BRANCH="${LI_GOAL_BRANCH:-cursor/li-research-homelab-r1}"
GOAL_FILE_REL="${LI_GOAL_FILE:-data/goal-directed-sprints/wp-li-research-r1-klaut.md}"
...
seed_goal() {
  ...
  if [[ -f /config/wp-li-research-r1-klaut.md ]]; then
    cp -f /config/wp-li-research-r1-klaut.md "${AGENTS_ROOT}/data/goal-directed-sprints/"
  fi
}
...
resolve_goal_file() {
  ...
  if [[ -f /config/wp-li-research-r1-klaut.md ]]; then
    echo "/config/wp-li-research-r1-klaut.md"
    return 0
  fi
  return 1
}
