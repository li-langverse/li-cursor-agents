...
sync_workspace(){ clone_or_sync "${ORG}/lic" "$LIC_ROOT" "$BRANCH_LIC"; clone_or_sync "${ORG}/li-os" "$LIOS_ROOT" "$BRANCH_LI_OS"; export LIC_ROOT; }
seed_loop_state(){
...
run_goal_loop(){
  ...
  export LIC_ROOT LIOS_ROOT LI_CURSOR_AGENTS_ROOT="$AGENTS_ROOT" LI_GOAL_LOOP_SLEEP_SEC="$LOOP_SLEEP"
