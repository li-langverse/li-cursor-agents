...
### klaut-research warm ingest (R1b)

- Deployment: `klaut-research-ingest` (namespace `li-swarm`, node `engine`, org **klaut-pro**)
- PVC: `klaut-research-ingest-workspace`; warm index hostPath `/warm-index` → `/srv/homelab/nvme/li-research/warm-index`
- S2 key: `secret-klaut-research-s2-api-key.yaml` (`klaut-research-s2-api-key` secret)
- Deploy: `.\scripts\deploy-klaut-research-ingest-k8s.ps1`
- Product track: `.\scripts\deploy-klaut-li-research-product-k8s.ps1`
- Verify on pod: `./scripts/unblock-r1b.sh` in `/workspace/klaut-research-ingest`
