...
export const META = {
  ...
  planner: {
    label: "Planner",
    deployment: "li-org-planner-supervisor",
    activeFile: "org-planner-active.json",
    auditKey: "planner",
    auditFile: "org-planner-audit.jsonl",
    queueFile: "org-planner-queue.json",
    countScript: null,
    openCountPattern: null,
    kubectlLogs:
      'kubectl -n li-swarm logs deploy/li-org-planner-supervisor -f --tail=100',
    kubectlJobs:
      'kubectl -n li-swarm get jobs -l li-langverse.io/managed-by=org-planner-supervisor',
  },
  pr: {
    ...
    kubectlJobs:
      'kubectl -n li-swarm get jobs -l li-langverse.io/managed-by=org-pr-supervisor',
  },
  review: {
    label: "PR reviewer",
    ...
    kubectlJobs:
      'kubectl -n li-swarm get jobs -l li-langverse.io/managed-by=org-reviewer-supervisor',
  },
  research: {
    label: "Researcher",
