...
| **C** | Local rebase dirty PRs (batch per repo, push) | **in progress** (~90 dirty; session 16: roadmap#39,#44 + benchmarks#247 merged; rebased #228,#249, lic#520) |
| **D** | Fix CI failures on remaining PRs | **in progress** (lip/lit queues 0 open; ~18 ci_not_ok; lic#520 CI pending) |
