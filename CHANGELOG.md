...
- **Studio X demo** — moved to [li-langverse/studio](https://github.com/li-langverse/studio) (`docs/demo/`, `scripts/record-studio-x-demo.sh`); pointer in `docs/demo/README.md`.
