...
upsert_env LI_WORKSPACE_PRUNE always
upsert_env LI_WORKSPACE_PRUNE_MAX_AGE_DAYS 7
upsert_env LI_WORKSPACE_PRUNE_KEEP_PER_REPO 5
upsert_env LI_WORKSPACE_PRUNE_MAX_RUNS_PER_REPO 20
