...
Environment=LI_AUTO_START_ASYNC_SWARM=1 LI_SWARM_DETACHED=0 LI_MAINTENANCE_LANE_ENABLED=1 LI_OBSERVER_STARTUP_DELAY_MS=15000 LI_MAINTENANCE_STARTUP_DELAY_MS=120000
...
Environment=HOME=$HOME PATH=$SERVICE_PATH LI_CURSOR_ENV_FILE=$ENV_FILE LI_CURSOR_AGENTS_ROOT=$ROOT
Environment=NODE_BIN=$NODE_BIN LI_CONTROL_PLANE_STORE=$STORE LI_SDK_MAX_CONCURRENT=$SDK_MAX LI_SWARM_MAX_PARALLEL=$SWARM_MAX
Environment=LI_RESEARCH_LANE_ENABLED=1 LI_IMPLEMENT_LANE_ENABLED=0
