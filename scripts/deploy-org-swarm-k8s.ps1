...
$manifests = @(
    ...
    "rbac-org-implement-goals-supervisor.yaml",
    "rbac-org-observer-supervisor.yaml",
    "rbac-org-ga-supervisor.yaml",
    ...
    "configmap-org-implement-goals-supervisor.yaml",
    "configmap-org-observer-supervisor.yaml",
    "configmap-org-ga-supervisor.yaml",
    ...
    "deployment-org-implement-goals-supervisor.yaml",
    "deployment-org-observer-supervisor.yaml",
    "deployment-org-ga-supervisor.yaml",
