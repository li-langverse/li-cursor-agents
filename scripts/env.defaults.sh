...
export LI_SWARM_MAX_PARALLEL="${LI_SWARM_MAX_PARALLEL:-4}"
export LI_AGENT_MAX_RUN_AGE_MS="${LI_AGENT_MAX_RUN_AGE_MS:-7200000}"
export LI_SWEEP_GRACE_MS="${LI_SWEEP_GRACE_MS:-1800000}"
export LI_SWEEP_KILL_GRACE_MS="${LI_SWEEP_KILL_GRACE_MS:-15000}"
