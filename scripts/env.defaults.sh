...
# Stale Cursor terminal cleanup (agent zsh -c / orphan test shells)
export LI_CURSOR_TERMINALS_CLEANUP="${LI_CURSOR_TERMINALS_CLEANUP:-1}"
export LI_CURSOR_TERMINALS_CLEANUP_LOOP="${LI_CURSOR_TERMINALS_CLEANUP_LOOP:-1}"
export LI_CURSOR_TERMINALS_CLEANUP_INTERVAL_SEC="${LI_CURSOR_TERMINALS_CLEANUP_INTERVAL_SEC:-7200}"
export LI_CURSOR_TERMINALS_AGENT_MAX_AGE_SEC="${LI_CURSOR_TERMINALS_AGENT_MAX_AGE_SEC:-7200}"
export LI_CURSOR_TERMINALS_INTERACTIVE_MAX_AGE_SEC="${LI_CURSOR_TERMINALS_INTERACTIVE_MAX_AGE_SEC:-14400}"
export LI_CURSOR_TERMINALS_ORPHAN_MAX_AGE_SEC="${LI_CURSOR_TERMINALS_ORPHAN_MAX_AGE_SEC:-14400}"
export LI_CURSOR_TERMINALS_GRACE_SEC="${LI_CURSOR_TERMINALS_GRACE_SEC:-120}"
