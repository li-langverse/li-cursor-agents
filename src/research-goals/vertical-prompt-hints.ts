...
const HINTS_BY_SLUG: Record<string, string[]> = {
  ...
  biology: ["Bioinformatics pipelines; li-std / package placement for models and I/O."],
  bioengineering: ["Tissue/bioprocess modeling; tie gaps to li-sim-scientific where relevant."],
  engineering: ["FEA/multiphysics incumbents; map to lic numerics and std packages."],
  additive: ["Slicing, lattice, process sim — reference AM stacks vs Li gaps."],
  robotics: ["Motion planning, control, perception — cite sim + AI packages on Li."],
  gaming: ["Engine UX patterns; optional li-gui / wasm paths for prototypes."],
  database: ["Query/embedded DB layers; handoff package_architect for new data crates."],
  server: ["httpd, services, observability — secure deploy story on Li."],
  ...
  machine_learning: ["Training/inference frameworks; package gaps vs PyTorch/JAX ecosystems."],
  deep_learning: ["Architectures and accelerators; bench validity before perf claims."],
  reinforcement_learning: ["Envs, policies, sim-to-real — link robotics vertical when relevant."],
  ai: ["AI-first tooling on Li — training, inference, agent integration."],
