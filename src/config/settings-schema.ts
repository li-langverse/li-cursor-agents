...
export const SETTINGS_SCHEMA: SettingDefinition[] = [
  ...
  {
    key: "LI_MAINTENANCE_LANE_ENABLED",
    label: "Maintenance lane enabled",
    description: "Refresh agent-briefing.json and work queue on an interval (no LLM). Set 0 to skip.",
    category: "lanes",
    type: "boolean",
    defaultValue: "1",
  ...
  {
    key: "LI_MAINTENANCE_LANE_INTERVAL_MS",
    label: "Maintenance lane interval (ms)",
    description: "Sleep between maintenance lane ticks (briefing refresh).",
    category: "lanes",
    type: "number",
    defaultValue: "300000",
    min: 30_000,
  ...
  {
    key: "LI_SWARM_CI_WORKER_ALWAYS_ON",
    label: "Swarm CI worker always on",
    description: "Background loop with async swarm; merges new swarm-labeled green/blocked org PRs.",
    category: "merge",
    type: "boolean",
    defaultValue: "0",
    restartRequired: true,
  ...
  {
    key: "LI_SWARM_CI_WORKER_INTERVAL_MS",
    label: "Swarm CI worker interval (ms)",
    description: "Delay between org merge cycles (minimum 60000).",
    category: "merge",
    type: "number",
    defaultValue: "300000",
    min: 60_000,
  ...
  {
    key: "LI_SWARM_CI_WORKER_MERGE_LIMIT",
    label: "Swarm CI worker merge limit",
    description: "Max squash merges per cycle (0 = unlimited).",
    category: "merge",
    type: "number",
    defaultValue: "8",
    min: 0,
  ...
  {
    key: "LI_SWARM_CI_WORKER_REQUIRE_LABELS",
    label: "Swarm CI worker require labels",
    description: "Only merge PRs matching at least one LI_SWARM_CI_WORKER_LABELS entry.",
    category: "merge",
    type: "boolean",
    defaultValue: "1",
  },
  {
    key: "LI_SWARM_CI_WORKER_LABELS",
    label: "Swarm CI worker labels",
    description: "Comma-separated GitHub labels (any match). Defaults to li-swarm + lane agent labels.",
    category: "merge",
    type: "string",
    defaultValue: "li-swarm,agent:ci_maintainer,agent:workspace_sweeper,agent:agent_kit_maintainer,agent:docs_maintainer,agent:code_implementer",
  },
  {
  ...
  {
    key: "LI_WORKSPACE_PRUNE",
    label: "Prune isolated workspaces",
    description: "Delete stale gh clones under data/workspaces/ (always or never).",
    category: "workspace",
    type: "enum",
    defaultValue: "always",
  ...
  {
    key: "LI_WORKSPACE_PRUNE_MAX_AGE_DAYS",
    label: "Workspace max age (days)",
    description: "Remove isolated clones older than this (newest N per repo always kept).",
    category: "workspace",
    type: "number",
    defaultValue: "7",
    min: 1,
  ...
  {
    key: "LI_WORKSPACE_PRUNE_KEEP_PER_REPO",
    label: "Workspaces kept per repo",
    description: "Minimum recent isolated clones to retain per repo.",
    category: "workspace",
    type: "number",
    defaultValue: "5",
    min: 0,
  ...
  {
    key: "LI_WORKSPACE_PRUNE_MAX_RUNS_PER_REPO",
    label: "Max workspace runs per repo",
    description: "Delete oldest clones beyond this count (even if younger than max age).",
    category: "workspace",
    type: "number",
    defaultValue: "20",
    min: 1,
  ...
  {
    key: "LI_WORKSPACE_PRUNE_INTERVAL_MS",
    label: "Workspace prune interval (ms)",
    description: "Minimum time between automatic prunes (supervisor / new clone).",
    category: "workspace",
    type: "number",
    defaultValue: String(3_600_000),
    min: 60_000,
    max: 86_400_000,
  },
  {
